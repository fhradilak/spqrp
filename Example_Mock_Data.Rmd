...
---
Hint: Try Restart R if you encounter any errors and rerun.
## Import Requirements
...
# if you receive an error even after restaring the R session try this with the path to the R reticulate cache
#unlink("path/to/_/AppData/Local/R/cache/R/reticulate", recursive = TRUE, force = TRUE)
library(reticulate)
virtualenv_remove("env", confirm = FALSE) 
py312 <- "path/to/python/environment" 
...
new_ranking = spqrp$retrieve_ranking(results)
```
